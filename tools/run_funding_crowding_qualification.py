...
from btc_quant_agent.funding_crowding_research import (
    SEED,
    audit_funding_data,
    run_v037_funding_qualification,
    write_v037_artifacts,
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--protocol",
        default="configs/research/v0.3.7_funding_crowding_protocol.json",
    )
    ...
    funding_audit, funding_events = audit_funding_data(funding_path, manifest)
    ...
    result = run_v037_funding_qualification(
        candles,
        funding_events,
        config,
        funding_audit,
