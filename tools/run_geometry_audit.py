...
def main() -> None:
    ...
    parser.add_argument("--protocol", default="configs/research/v0.3.3_geometry_protocol.json")
    ...
    result = run_v033_geometry_audit(candles, config, funding)
    output = write_v033_artifacts(
        args.output,
        result,
        config,
