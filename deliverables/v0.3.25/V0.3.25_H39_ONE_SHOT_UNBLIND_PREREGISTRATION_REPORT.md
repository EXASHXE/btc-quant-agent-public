...
| **Protocol Clarification 002** | `6e1259409aa4f1cedf86b7a424666ee7c942a929` | COMMITTED | Overlapping outcome serial dependence and robust inference |
...
| **Current Reviewable SHA** | `304fb0d276508ce1ba8ae9bb617c94202f66879c` | READY_FOR_REVIEW | Full gatekeeper & preregistration implementation |
...
| **Eligible Coverage Ratio** | `16.52%` | `>= 90.0%` | `PENDING` | Denominator: wall-clock expected boundaries |
| **Raw Observation Coverage** | `24.55%` | N/A | Total recorded / Expected boundaries |
| **Expected Boundaries** | `224` | N/A | Clock-based (WALL_CLOCK) |
| **Clock Ceiling UTC** | `2026-09-06T19:08:41.651000+00:00` | N/A | Current wall-clock ceiling |
