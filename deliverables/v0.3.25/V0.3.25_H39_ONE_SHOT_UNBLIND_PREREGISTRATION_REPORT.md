...
| **Current Reviewable SHA** | `5d055ae17798bdc00e1b0d6388596ecd59358251` | READY_FOR_REVIEW | Full gatekeeper & preregistration implementation |
...
| **Eligible Coverage Ratio** | `14.02%` | `>= 90.0%` | `PENDING` | Denominator: wall-clock expected boundaries |
| **Raw Observation Coverage** | `20.83%` | N/A | Total recorded / Expected boundaries |
| **Expected Boundaries** | `264` | N/A | Clock-based (WALL_CLOCK) |
| **Clock Ceiling UTC** | `2026-09-07T05:10:32.225000+00:00` | N/A | Current wall-clock ceiling |
