...
| **Current Reviewable SHA** | `45c9e2d7779338e2064879e83c2859771bd2ce48` | READY_FOR_REVIEW | Full gatekeeper & preregistration implementation |
...
| **Eligible Coverage Ratio** | `18.32%` | `>= 90.0%` | `PENDING` | Denominator: wall-clock expected boundaries |
| **Raw Observation Coverage** | `27.23%` | N/A | Total recorded / Expected boundaries |
| **Expected Boundaries** | `202` | N/A | Clock-based (WALL_CLOCK) |
| **Clock Ceiling UTC** | `2026-09-06T13:34:38.484000+00:00` | N/A | Current wall-clock ceiling |
