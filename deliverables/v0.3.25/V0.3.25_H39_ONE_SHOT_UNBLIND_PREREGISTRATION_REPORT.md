...
| **Current Reviewable SHA** | `7bb33d7335ca4d7beb427d0d4a260602a49ba129` | READY_FOR_REVIEW | Full gatekeeper & preregistration implementation |
...
| **Eligible Coverage Ratio** | `17.37%` | `>= 90.0%` | `PENDING` | Denominator: wall-clock expected boundaries |
| **Raw Observation Coverage** | `25.82%` | N/A | Total recorded / Expected boundaries |
| **Expected Boundaries** | `213` | N/A | Clock-based (WALL_CLOCK) |
| **Clock Ceiling UTC** | `2026-09-06T16:17:00.881000+00:00` | N/A | Current wall-clock ceiling |
