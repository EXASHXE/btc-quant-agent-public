...
| **Current Reviewable SHA** | `04d1ea87827e7645bbcb2481f2dbf9fff4473b94` | READY_FOR_REVIEW | Full gatekeeper & preregistration implementation |
...
| **Eligible Coverage Ratio** | `18.59%` | `>= 90.0%` | `PENDING` | Denominator: wall-clock expected boundaries |
| **Raw Observation Coverage** | `27.64%` | N/A | Total recorded / Expected boundaries |
| **Expected Boundaries** | `199` | N/A | Clock-based (WALL_CLOCK) |
| **Clock Ceiling UTC** | `2026-09-06T12:50:39.842000+00:00` | N/A | Current wall-clock ceiling |
